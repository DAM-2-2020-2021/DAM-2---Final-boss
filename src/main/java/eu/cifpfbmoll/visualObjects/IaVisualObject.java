...
public class IaVisualObject extends DynamicVisualObject {

    public IaVisualObject(LogicController logicController, Vector2D velocity, Vector2D position, double maxVel,
